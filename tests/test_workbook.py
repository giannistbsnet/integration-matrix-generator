...
class WorkbookGenerationTest(unittest.TestCase):
    def test_generates_expected_three_component_workbook(self):
        ...
        self.assertEqual(matrix["F3"].value, '=IF(D4="","",IF(D4="↗","↙",IF(D4="↙","↗",D4)))')
        self.assertEqual(matrix["G3"].value, '=IF(E4="","",E4)')
        self.assertEqual(matrix["H3"].value, '=IF(D5="","",IF(D5="↗","↙",IF(D5="↙","↗",D5)))')
        self.assertEqual(matrix["I3"].value, '=IF(E5="","",E5)')
        self.assertEqual(matrix["H4"].value, '=IF(F5="","",IF(F5="↗","↙",IF(F5="↙","↗",F5)))')
        self.assertEqual(matrix["I4"].value, '=IF(G5="","",G5)')
